"""This module is used to gather enumerations related to the Channel resource in Teleflow"""

from teleflow.enums.polyfill import StrEnum


class Channel(StrEnum):
    """This enumeration define all available channel in Teleflow"""
...
class ChannelExtended(StrEnum):
    """
    This enumeration define all available channel in Teleflow and intermediate provider between channel.
