"""This module is used to gather enumerations related to the Execution resource in Teleflow"""

from teleflow.enums.polyfill import StrEnum


class ExecutionSource(StrEnum):
    """This enumeration define all sources possible for an execution in Teleflow"""
...
class ExecutionStatus(StrEnum):
    """This enumeration define all status possible for an execution in Teleflow"""
