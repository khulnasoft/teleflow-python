"""This module is used to gather all DTO definitions related to the Integration resource in Teleflow"""

import dataclasses
from typing import Dict, Optional, Union

from teleflow.dto.base import CamelCaseDto
from teleflow.enums import Channel, CredentialsKeyEnum, ProviderIdEnum
...
class IntegrationDto(CamelCaseDto["IntegrationDto"]):  # pylint: disable=R0902
    ...
    """Integration ID in Teleflow internal storage system"""
