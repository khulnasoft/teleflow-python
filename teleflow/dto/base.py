"""This module is used to defined all helpers to parse and send well-formatted data to the Teleflow API"""
...
class CamelCaseDto(Generic[_T]):
    """A generic dataclass that allows to convert data from Teleflow API written in
...
class DtoDescriptor(Generic[_C_co]):
    ...
    the :class:`~teleflow.dto.base.CamelCaseDto` class during :meth:`~teleflow.dto.base.CamelCaseDto.from_camel_case` calls
    on Teleflow API response.
...
class DtoIterableDescriptor(Generic[_C_co]):
    ...
    defined using the :class:`~teleflow.dto.base.CamelCaseDto` class during
    :meth:`~teleflow.dto.base.CamelCaseDto.from_camel_case` calls on Teleflow API response.
