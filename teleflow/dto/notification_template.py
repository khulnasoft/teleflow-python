"""This module is used to gather all DTO definitions related to the Notification Template resource in Teleflow"""

import dataclasses
from typing import List, Optional

from teleflow.dto.base import CamelCaseDto, DtoDescriptor, DtoIterableDescriptor
from teleflow.dto.notification_group import NotificationGroupDto
from teleflow.dto.step_filter import StepFilterDto
from teleflow.dto.subscriber import SubscriberPreferenceChannelDto
...
class NotificationStepDto(CamelCaseDto["NotificationStepDto"]):  # pylint: disable=R0902
    ...
    """Notification Step ID in Teleflow internal storage system"""

    _template_id: Optional[str] = None
    """Notification Template ID in Teleflow internal storage system"""

    _parent_id: Optional[str] = None
    """Notification Step ID in Teleflow internal storage system (parent of this step)"""
...
class NotificationTemplateFormDto(CamelCaseDto["NotificationTemplateDto"]):  # pylint: disable=R0902
    ...
    """Notification Group ID from Teleflow internal storage system"""
...
class NotificationTemplateDto(CamelCaseDto["NotificationTemplateDto"]):  # pylint: disable=R0902
    ...
    """Notification Group ID in Teleflow internal storage system"""

    _parent_id: Optional[str] = None
    """Parent ID in Teleflow internal storage system"""

    _creator_id: Optional[str] = None
    """Creator ID in Teleflow internal storage system"""
