"""This module is used to gather all DTO definitions related to the Execution Detail resource in Teleflow"""

import dataclasses
from typing import Optional

from teleflow.dto.base import CamelCaseDto
from teleflow.enums import ChannelExtended, ExecutionSource, ExecutionStatus
...
class ExecutionDetailDto(CamelCaseDto["ExecutionDetailDto"]):  # pylint: disable=R0902
    ...
    """Execution detail ID in Teleflow internal storage system"""

    _job_id: Optional[str] = None
    """Job ID in Teleflow internal storage system"""
    ...
    """Notification ID in Teleflow internal storage system"""
    ...
    """Subscriber ID in Teleflow internal storage system"""

    _message_id: Optional[str] = None
    """Message ID in Teleflow internal storage system"""

    provider_id: Optional[str] = None
    """Provider ID in Teleflow internal storage system"""

    transaction_id: Optional[str] = None
    """Transaction ID in Teleflow internal storage system"""
