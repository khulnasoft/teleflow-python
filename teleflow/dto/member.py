"""This module is used to gather all DTO definitions related to the Member resource in Teleflow."""

import dataclasses
from typing import List, Optional

from teleflow.dto.base import CamelCaseDto, DtoDescriptor
from teleflow.enums import MemberRole, MemberStatus
...
class MemberUserDto(CamelCaseDto["MemberUserDto"]):
    ...
    """User ID in Teleflow internal storage system"""
...
class MemberInviteDto(CamelCaseDto["MemberInviteDto"]):
    ...
    """Invitation ID in Teleflow internal storage system"""
...
class MemberDto(CamelCaseDto["MemberDto"]):
    ...
    _id: Optional[str] = None
    """Member ID in Teleflow internal storage system"""
