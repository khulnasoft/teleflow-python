"""This module is used to gather all DTO definitions related to the Subscriber resource in Teleflow"""

import dataclasses
from typing import List, Optional

from teleflow.dto.base import CamelCaseDto, DtoDescriptor, DtoIterableDescriptor
from teleflow.enums.provider import ProviderIdEnum
...
class SubscriberPreferenceTemplateDto(CamelCaseDto["SubscriberPreferenceTemplateDto"]):
    ...
    """Defines if the user's preferences will be ignored or not by Teleflow for the given template.

    By defining the template as critical, Teleflow considers that all steps should be executed ignoring user preferences.
    """
...
class SubscriberPreferenceDto(CamelCaseDto["SubscriberPreferenceDto"]):
    ...
    """Sub-struct in Teleflow for preference / global activation state"""
