"""This module is used to gather all DTO definitions related to the Environment resource in Teleflow"""
...
class EnvironmentApiKeyDto(CamelCaseDto["EnvironmentApiKeyDto"]):
    ...
    """Environment's API Key ID in Teleflow internal storage system"""
