"""This module is used to gather all DTO definitions related to the Message resource in Teleflow"""
...
class MessageDto(CamelCaseDto["MessageDto"]):  # pylint: disable=R0902
    ...
    """Message Notification ID in Teleflow internal storage system"""

    _template_id: Optional[str] = None
    """Template ID in Teleflow internal storage system"""
    ...
    """Message Template ID in Teleflow internal storage system"""
