"""This module is used to gather all DTO definitions related to the Notifications resource in Teleflow"""
...
class ActivityGraphStatesDto(CamelCaseDto["ActivityGraphStatesDto"]):
    """Definition of an activity graph states in Teleflow."""

    _id: str
    """Activity graph states ID in Teleflow internal storage system"""
