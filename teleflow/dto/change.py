"""This module is used to gather all DTO definitions related to the Change resource in Teleflow"""

import dataclasses
from typing import Any, List, Optional

from teleflow.dto.base import CamelCaseDto, DtoIterableDescriptor
from teleflow.enums import ChangeKind
...
class ChangeDto(CamelCaseDto["ChangeDto"]):  # pylint: disable=R0902
    ...
    """Change ID in Teleflow internal storage system"""
    ...
    """Entity ID in Teleflow internal storage system"""
