"""This module is used to gather all DTO definitions related to the Layout resource in Teleflow"""

import dataclasses
from typing import Optional

from teleflow.dto.base import CamelCaseDto, DtoIterableDescriptor
from teleflow.enums import Channel, TemplateVariableTypeEnum
...
class LayoutVariableDto(CamelCaseDto["LayoutVariableDto"]):
    ...
    """Layout variable ID in the Teleflow storage system"""
...
class LayoutDto(CamelCaseDto["LayoutDto"]):  # pylint: disable=R0902
    ...
    _id: Optional[str] = None
    """Layout ID in Teleflow internal storage system"""
