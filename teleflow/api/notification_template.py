...
to interact with ``NotificationTemplate`` in Teleflow.
"""
...
class NotificationTemplateApi(Api):
    ...
    def get(self, notification_template_id: str) -> NotificationTemplateDto:
        """Retrieve a notification template using it's Teleflow ID

        Args:
            notification_template_id: The Teleflow ID of the notification template
