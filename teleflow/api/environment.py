"""
This module is used to define the ``EnvironmentApi``, a python wrapper to interact with ``Environments`` in Teleflow.
"""
...
class EnvironmentApi(Api):
    """This class aims to handle all API methods around environments in Teleflow"""
