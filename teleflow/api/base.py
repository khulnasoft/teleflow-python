"""This module is used to defined an abstract class for all reusable methods to communicate with the Teleflow API"""
...
class Api:  # pylint: disable=R0903
    """Base class for all API in the Teleflow client"""
    ...
    def __init__(
        ...
        self.requests_timeout = requests_timeout or int(os.getenv("TELEFLOW_PYTHON_REQUESTS_TIMEOUT", "5"))
