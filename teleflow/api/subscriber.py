"""
This module is used to define the ``SubscriberApi``, a python wrapper to interact with ``Subscribers`` in Teleflow.
"""
...
from teleflow.enums import Channel, MarkAsEnum, MessageActionStatus, ProviderIdEnum
...
class SubscriberApi(Api):
    ...
    def create(self, subscriber: SubscriberDto) -> SubscriberDto:
        """Method to push a given subscriber instance to Teleflow

        Args:
            subscriber: The subscriber instance to push to Teleflow

        Returns:
            The instance retrieved from Teleflow (populated after creation)
        """
    ...
    def bulk_create(self, subscribers: Iterator[SubscriberDto]) -> BulkResultSubscriberDto:
        ...
        Args:
            subscribers: An iterator of subscribers instance to push to Teleflow

        Returns:
            Result of the bulk operation in Teleflow.
        """
    ...
    def put(self, subscriber: SubscriberDto) -> SubscriberDto:
        ...
        Returns:
            Updated subscriber instance from Teleflow API
        """
        return SubscriberDto.from_camel_case(
            self.handle_request(
