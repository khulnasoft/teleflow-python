"""
This module is used to define the ``EventApi``, a python wrapper to interact with ``Events`` in Teleflow.
"""
...
class EventApi(Api):
    """This class aims to handle all API methods around events in Teleflow"""
    ...
    def trigger(
        ...
        .. note:: If you want to use topic, please use
                  :meth:`~teleflow.api.event.EventApi.trigger_topic` instead

        .. warning:: For the "recipients" attribute, the part allowing the dynamic creation of
                     subscribers in the Teleflow AP was deliberately removed from the wrapper
        ...
        Returns:
            Create Event definition in Teleflow
        """
    ...
    def trigger_bulk(
        ...
        Returns:
            List[EventDto]: List of created Teleflow events.
        """
    ...
    def trigger_topic(
        ...
        .. note:: If you want to use subscriber ID, please use :meth:`~teleflow.api.event.EventApi.trigger` instead
