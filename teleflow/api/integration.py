"""
This module is used to define the ``IntregrationApi``, a python wrapper to interact with ``Integrations`` in Teleflow.
"""
...
class IntegrationApi(Api):
    ...
    def create(self, integration: IntegrationDto, check: bool = True) -> IntegrationDto:
        ...
        Args:
            ...
            check:
                If you want the Teleflow server to check his connection using given integration configuration.
                Defaults to True.
