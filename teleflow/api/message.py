"""
This module is used to define the ``MessageApi``, a python wrapper to interact with ``Messages`` in Teleflow.
"""
...
from teleflow.khulnasoft.comnstants import MESSAGES_ENDPOINT


class MessageApi(Api):
    """This class aims to handle all API methods around messages in Teleflow"""
