"""
This module is used to define the ``FeedApi``, a python wrapper to interact with ``Feeds`` in Teleflow.
"""
...
class FeedApi(Api):
    """This class aims to handle all API methods around feeds in Teleflow"""
    ...
    def delete(self, feed_id: str) -> None:
        ...
        Args:
            feed_id: The feed identifier in Teleflow internal storage system (``_id``)
        """
