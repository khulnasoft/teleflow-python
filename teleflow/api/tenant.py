"""
This module is used to define the ``TenantApi``, a python wrapper to interact with ``Tenants`` in Teleflow.
"""
...
class TenantApi(Api):
    ...
    def get(self, identifier: str) -> TenantDto:
        ...
        Args:
            identifier: The tenant identifier (ID in Teleflow)
    ...
    def patch(
        ...
        Args:
            reference: Current identifier of the tenant in Teleflow
    ...
    def delete(self, identifier: str) -> None:
        ...
        Args:
            identifier: Current identifier of the tenant in Teleflow
        """
