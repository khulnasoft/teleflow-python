...
class IntegrationApiTests(TestCase):
    ...
    def test_list_no_result(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.com/v1/integrations",
    ...
    def test_list_only_active_no_result(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.com/v1/integrations/active",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
    ...
    def test_get_provider_status(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.com/v1/integrations/webhooks/provider/something/status",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
    ...
    def test_update_with_check_by_default(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="PUT",
            url="sample.teleflow.com/v1/integrations/identifier",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json={
                "providerId": EmailProviderIdEnum.CUSTOM_SMTP,
                "channel": Channel.EMAIL,
    ...
    def test_limit(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.com/v1/integrations/email/limit",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
    ...
    def test_set_primary_with_valid_integration_id(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="POST",
            url="sample.teleflow.com/v1/integrations/63dfe50ecac5cff328ca5d24/set-primary",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
    ...
    def test_set_primary_with_invalid_integration_id(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="POST",
            url="sample.teleflow.com/v1/integrations/63dfe50ecac5cff328ca5d23/set-primary",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
