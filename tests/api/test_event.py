...
class EventApiTests(TestCase):
    ...
    def test_trigger_with_single_recipient(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="POST",
            url="sample.teleflow.com/v1/events/trigger",
    ...
    def test_trigger_bulk_with_one_event(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="POST",
            url="sample.teleflow.com/v1/events/trigger/bulk",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json={
                "events": [
    ...
    def test_broadcast_with_overrides(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="POST",
            url="sample.teleflow.com/v1/events/trigger/broadcast",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json={
                "name": "test-template",
                "payload": {},
    ...
    def test_delete(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="DELETE",
            url="sample.teleflow.com/v1/events/trigger/sample-test",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
