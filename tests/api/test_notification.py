...
class NotificationApiTests(TestCase):
    ...
    def test_list(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.khulnasoft.com/v1/notifications",
    ...
    def test_stats(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.khulnasoft.com/v1/notifications/stats",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
    ...
    def test_graph_stats(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.khulnasoft.com/v1/notifications/graph/stats",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params={
                "id": "123",
    ...
    def test_get(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url=f"sample.teleflow.khulnasoft.com/v1/notifications/{notification_id}",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
