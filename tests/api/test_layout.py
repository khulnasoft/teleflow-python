...
class LayoutApiTests(TestCase):
    ...
    def test_list_layout(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.com/v1/layouts",
    ...
    def test_get_layout(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.com/v1/layouts/63dafeda7779f59258e38450",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
    ...
    def test_set_default_layout(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="POST",
            url="sample.teleflow.com/v1/layouts/63dafeda7779f59258e38450/default",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
