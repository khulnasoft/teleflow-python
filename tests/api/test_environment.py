...
class EnvironmentApiTests(TestCase):
    ...
    def test_list_environments(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.khulnasoft.com/v1/environments",
    ...
    def test_get_current_environment(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.khulnasoft.com/v1/environments/me",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
    ...
    def test_list_environment_api_keys(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.khulnasoft.com/v1/environments/api-keys",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
    ...
    def test_regenerate_api_key(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="POST",
            url="sample.teleflow.khulnasoft.com/v1/environments/api-keys/regenerate",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
