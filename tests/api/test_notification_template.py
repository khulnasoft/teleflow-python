...
class NotificationTemplateApiTests(TestCase):
    ...
    def test_list_notification_template(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.khulnasoft.com/v1/notification-templates",
    ...
    def test_get_notification_template(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="GET",
            url="sample.teleflow.khulnasoft.com/v1/notification-templates/63daff36c037e013fd82d9fc",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json=None,
            params=None,
            timeout=5,
    ...
    def test_update_status_notification_template(self, mock_request: mock.MagicMock) -> None:
        ...
        mock_request.assert_called_once_with(
            method="PUT",
            url="sample.teleflow.khulnasoft.com/v1/notification-templates/63daff36c037e013fd82d9fc/status",
            headers={"Authorization": "ApiKey api-key", "User-Agent": f"teleflow/python@{__version__}"},
            json={"active": True},
            params=None,
            timeout=5,
